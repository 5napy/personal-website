        ...
        <div className="flex flex-row justify-between items-center gap-18">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              {/* LinkedIn */}
              <a 
                href="https://www.linkedin.com/in/bgustavo" 
                target="_blank" 
                className="flex items-center gap-2 text-black hover:text-gray-300 transition-all duration-300 hover:-translate-y-0.5"
              >
              ...
              {/* Email */}
              <a 
                href="mailto:gusbz.117@gmail.com" 
                className="flex items-center gap-2 text-black hover:text-gray-300 transition-all duration-300 hover:-translate-y-0.5"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
